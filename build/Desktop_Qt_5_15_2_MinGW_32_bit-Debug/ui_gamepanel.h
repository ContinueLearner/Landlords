...
public:
    ...
    void setupUi(QMainWindow *GamePanel)
    {
        ...
        verticalSpacer_2 = new QSpacerItem(30, 30, QSizePolicy::Policy::Fixed, QSizePolicy::Minimum);
    ...
    {
        GamePanel->setWindowTitle(QCoreApplication::translate("GamePanel", "MainWindow", nullptr));
    } // retranslateUi
